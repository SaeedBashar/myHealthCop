...
window.onload = () => {
    ...
    if(_get('#registeredUsersChart')){
        buildRegisteredUsersChart()
    }
...
const buildUsersChart = ()=>{
    new ApexCharts(_get("#usersChart"), {
...
const buildRegisteredUsersChart = ()=>{
    const series = {
        "monthDataSeries1": {
          "prices": [
            8107.85,
      ...
      new ApexCharts(_get("#registeredUsersChart"), {
        series: [{
          name: "STOCK ABC",
...
const buildDemography = ()=>{
    new ApexCharts(document.querySelector("#demography"), {
        series: [44, 55, 13, 43, 22],
        chart: {
          height: 350,
          type: 'donut',
